...
window.addEventListener('DOMContentLoaded', () => {
   ...
   fetch(' http://localhost:3000/menu')
      .then(data => data.json())  // берем тот  ответ от сервера и превращаем его в обычный JS объект 
      .then(res => console.log(res)) // выводим тот результат в консоль мы просто fetchim те данные которые находятся в файлике 
